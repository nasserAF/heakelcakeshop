...
var firebaseConfig = {
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    var materialStatusInput = document.getElementById("materialStatusInput")
    ...
    userForm.addEventListener("submit", function (event) {
      ...
      userMterialStatus = materialStatusInput.value;
      ...
      var userData = {
        ...
        mobile: userMobile,
        email:userEmail,
        materialStatus: userMterialStatus,
        address: userAddress,
      ...
      var newUserDataRef = database.ref("candidateForJob2").push();
